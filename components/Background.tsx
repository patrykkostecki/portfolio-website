...
export function Background() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="blob animate-floaty left-[-12%] top-[-8%] h-[38rem] w-[38rem] bg-[rgba(28,97,214,0.16)]" />
      <div className="blob animate-floaty-slow right-[-14%] top-[12%] h-[42rem] w-[42rem] bg-[rgba(136,33,153,0.13)]" />
      <div className="blob animate-floaty bottom-[-18%] left-[18%] h-[36rem] w-[36rem] bg-[rgba(56,182,255,0.1)]" />
      <div className="blob animate-floaty-slow right-[22%] bottom-[-10%] h-[28rem] w-[28rem] bg-[rgba(99,100,199,0.1)]" />
